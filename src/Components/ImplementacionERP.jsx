                        ...
                        >
                            <div className="h-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h3 className="text-xl font-semibold text-white mb-4">{beneficio.title}</h3>
                                ...
                                {etapasImplementacion.map((etapa, index) => (
                                    ...
                                    >
                                        <div className="flex-shrink-0 mt-1 mr-4">
                                            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-400 to-teal-400 flex items-center justify-center text-xs font-bold">
                                                {index + 1}
                                            </div>
                                        </div>
                                        <span className="text-blue-100 text-lg">{etapa}</span>
                                    </motion.div>
                                ))}
                            </div>
                        </div>
