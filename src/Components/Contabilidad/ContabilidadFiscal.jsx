// src/components/ContabilidadFiscal.tsx
...
const ContabilidadFiscal = () => {
    const benefits = [
        {
            ...
            icon: <FiShield className="text-blue-400 text-xl" />, // Tamaño aumentado
            color: "from-blue-500/10 to-blue-400/10"
        },
        {
            title: "Optimización Legal",
            description: "Legalmente reducimos tu carga tributaria y maximizamos tus beneficios fiscales.",
            icon: <FiPercent className="text-teal-400 text-xl" />, // Tamaño aumentado
            color: "from-teal-500/10 to-teal-400/10"
        },
        {
            title: "Prevención de Riesgos",
            description: "Identificamos y mitigamos posibles contingencias fiscales antes de que ocurran.",
            icon: <FiCalendar className="text-amber-400 text-xl" />, // Tamaño aumentado
            color: "from-amber-500/10 to-amber-400/10"
        },
        {
            title: "Representación Profesional",
            description: "Te representamos ante el SAT con total seguridad y conocimiento técnico.",
    ...
    const trustFactors = [
        { number: "8+", label: "Años de Experiencia", icon: <FiFileText className="text-blue-400 text-xl" /> }, // Tamaño aumentado
        { number: "20+", label: "Clientes Atendidos", icon: <FiCheckCircle className="text-teal-400 text-xl" /> }, // Tamaño aumentado
        { number: "99%", label: "Cumplimiento SAT", icon: <FiShield className="text-purple-400 text-xl" /> }, // Tamaño aumentado
        { number: "0", label: "Multas Emitidas", icon: <FiCalendar className="text-amber-400 text-xl" /> } // Tamaño aumentado
    ];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-xs font-semibold text-blue-300 tracking-widest">ASESORÍA FISCAL EXPERTA</span>
                    </motion.div>
                    ...
                    <p className="text-lg text-blue-100/80 max-w-3xl mx-auto leading-relaxed font-light">
                        Navega el complejo mundo fiscal con total tranquilidad.
                        Nuestra asesoría fiscal experta garantiza el cumplimiento,
                        optimiza legalmente tus impuestos y te protege de contingencias,
                        permitiéndote enfocarte en hacer crecer tu negocio.
                    </p>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-28">
                    ...
                    >
                        <h3 className="text-2xl md:text-3xl font-bold mb-6 text-white">
                            Servicios Fiscales Completos
                        </h3>
                        <p className="text-blue-100/90 mb-8 leading-relaxed">
                            Nuestro servicio de contabilidad fiscal cubre todas tus obligaciones,
                            desde las declaraciones rutinarias hasta asesoría estratégica,
                            garantizando tu tranquilidad y el crecimiento seguro de tu empresa.
                        </p>
                ...
                {/* Compliance section mejorada */}
                <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    whileHover={{ y: -5 }} // Efecto lift en el contenedor del compliance
                ...
                >
                    {/* Elementos flotantes decorativos en el compliance */}
                    ...
                    <div className="text-center max-w-4xl mx-auto relative z-10">
                        ...
                        <h4 className="text-2xl font-bold text-white mb-4">Compromiso con el Cumplimiento</h4>
                        <p className="text-lg text-blue-100/90 mb-8 leading-relaxed">
                            Nuestro equipo de expertos fiscales se mantiene actualizado con las últimas normativas
                            para garantizar que tu empresa siempre esté en regla. Trabajamos proactivamente para
                            prevenir problemas y asegurar tu tranquilidad fiscal.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { stat: "100%", label: "Actualización Normativa", desc: "Permanente de leyes fiscales" },
                                { stat: "24h", label: "Respuesta a Consultas", desc: "Soporte fiscal continuo" },
                                { stat: "0%", label: "Errores en Declaraciones", desc: "Garantizados por nuestro sistema" }
                            ].map((item, index) => (
                                <motion.div
                                    key={index}
