...
const ContabilidadCostos = () => {
    ...
    const services = [
        "Análisis de Costos Directos/Indirectos",
        "Costeo por Procesos/Órdenes",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <h4 className="text-2xl font-bold text-white mb-4">Resultados que Hablan por Sí Solos</h4>
                        <p className="text-lg text-blue-100/90 mb-8 leading-relaxed">
                            Nuestras soluciones de contabilidad de costos han ayudado a cientos de empresas
                            a identificar ahorros promedio del 30% en sus operaciones, incrementando su
                            rentabilidad sin afectar la calidad de sus productos o servicios.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { stat: "35%", label: "Reducción de Costos Operativos", desc: "En el primer año" },
