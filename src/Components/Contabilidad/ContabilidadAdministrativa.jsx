// src/components/ContabilidadAdministrativa.tsx
...
const ContabilidadAdministrativa = () => {
    const benefits = [
        {
            ...
            icon: <FiSettings className="text-blue-400 text-xl" />, // Tamaño aumentado
        ...
        },
        {
            ...
            icon: <FiDatabase className="text-teal-400 text-xl" />, // Tamaño aumentado
        ...
        },
        {
            ...
            icon: <FiBarChart2 className="text-amber-400 text-xl" />, // Tamaño aumentado
    ...
    const trustFactors = [
        { number: "8+", label: "Años de Experiencia", icon: <FiBookOpen className="text-blue-400 text-xl" /> }, // Tamaño aumentado
        { number: "20+", label: "Procesos Optimizados", icon: <FiSettings className="text-teal-400 text-xl" /> }, // Tamaño aumentado
        { number: "92%", label: "Eficiencia Alcanzada", icon: <FiTrendingUp className="text-purple-400 text-xl" /> }, // Tamaño aumentado
        { number: "24/7", label: "Soporte Técnico", icon: <FiUsers className="text-amber-400 text-xl" /> } // Tamaño aumentado
    ];
                        ...
                        <div className="grid grid-cols-1 gap-4 mb-10">
                            {services.map((service, index) => (
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                    transition={{ delay: 0.1 * index }}
                                    whileHover={{ y: -3, backgroundColor: "rgba(255, 255, 255, 0.05)" }} // Efecto lift y cambio de fondo
