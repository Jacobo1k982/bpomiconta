...
import { FiSend, FiShield, FiCheckCircle, FiArrowRight, FiBarChart2, FiLock, FiFileText, FiTrendingUp } from 'react-icons/fi';

const FacturacionElectronica = () => {
    const benefits = [
        {
            title: "Legalidad Garantizada",
            description: "Cumplimiento total con las normativas del SAT y autoridades fiscales.",
            icon: <FiShield className="text-blue-400" />,
            color: "from-blue-500/10 to-blue-400/10"
        },
        {
            title: "Seguridad Máxima",
            description: "Protección avanzada de datos con encriptación de última generación.",
    ...
    const trustFactors = [
        { number: "10+", label: "Años de Experiencia", icon: <FiFileText className="text-blue-400" /> },
        { number: "1500+", label: "Empresas Certificadas", icon: <FiCheckCircle className="text-teal-400" /> },
        { number: "99.9%", label: "Disponibilidad del Sistema", icon: <FiShield className="text-purple-400" /> },
        { number: "0", label: "Errores Reportados", icon: <FiLock className="text-amber-400" /> }
    ];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <div className="inline-flex items-center px-5 py-2 rounded-full bg-gradient-to-r from-blue-500/10 to-indigo-500/10 backdrop-blur-xl border border-white/10 mb-6">
                        <FiSend className="text-blue-400 mr-2" />
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
                        ...
                        <span className="block mt-2 text-white/90">
                            Control Total de Comprobantes Fiscales
                        </span>
                    </h2>

                    <p className="text-lg text-blue-100/80 max-w-3xl mx-auto leading-relaxed font-light">
                        Confía en nuestra solución certificada por el SAT para emitir, gestionar
                        y controlar todos tus comprobantes fiscales con la máxima seguridad,
                        legalidad y eficiencia que tu empresa merece.
                    </p>
                </motion.div>
                            ...
                            <div className="bg-gradient-to-br from-gray-900/70 to-blue-900/10 rounded-3xl p-8">
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <div className="flex items-center bg-gradient-to-r from-green-500/15 to-teal-500/15 text-green-300 px-3 py-1.5 rounded-full border border-green-500/20">
                                        ...
                                        <span className="text-xs font-medium">SAT CERTIFICADO</span>
                                    </div>
                                </div>
                ...
                >
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <h4 className="text-2xl font-bold text-white mb-4">Seguridad y Confianza Garantizadas</h4>
                        <p className="text-lg text-blue-100/90 mb-8 leading-relaxed">
                            ...
                            informática y está certificada por las autoridades fiscales.
                            Miles de empresas confían en nosotros para manejar su facturación
                            electrónica con total tranquilidad y cumplimiento.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { stat: "AES-256", label: "Encriptación de Datos", desc: "Máximo nivel de seguridad" },
                                { stat: "99.9%", label: "Disponibilidad", desc: "Garantizada del sistema" },
                                { stat: "24/7", label: "Soporte Técnico", desc: "Respuesta inmediata" }
                            ].map((item, index) => (
                                <div key={index} className="p-6 rounded-2xl bg-gradient-to-br from-white/5 to-white/1 backdrop-blur-sm border border-white/10">
                                    <p className="text-xl font-bold text-blue-300 mb-2">{item.stat}</p>
