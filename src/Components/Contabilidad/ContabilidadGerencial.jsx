// src/components/ContabilidadGerencial.tsx
import React from 'react';
import { motion } from 'framer-motion';
import { FiBarChart2, FiTrendingUp, FiTarget, FiUsers, FiCheckCircle, FiArrowRight, FiPieChart, FiActivity, FiDatabase } from 'react-icons/fi';

const ContabilidadGerencial = () => {
    const benefits = [
        {
            title: "Visión Estratégica",
            description: "Información financiera clara para decisiones gerenciales acertadas.",
            icon: <FiTarget className="text-blue-400 text-xl" />, // Tamaño aumentado
            color: "from-blue-500/10 to-blue-400/10"
        },
        {
            title: "Control de Gestión",
            description: "Monitoreo continuo del desempeño y rentabilidad por áreas.",
            icon: <FiActivity className="text-teal-400 text-xl" />, // Tamaño aumentado
            color: "from-teal-500/10 to-teal-400/10"
        },
        {
            title: "Indicadores Clave (KPIs)",
            description: "Métricas precisas para evaluar el éxito de tus estrategias.",
            icon: <FiBarChart2 className="text-purple-400 text-xl" />, // Tamaño aumentado
            color: "from-purple-500/10 to-purple-400/10"
        },
        {
            title: "Optimización de Recursos",
            description: "Identifica áreas de mejora y maximiza la eficiencia operativa.",
            icon: <FiTrendingUp className="text-amber-400 text-xl" />, // Tamaño aumentado
    ...
    const trustFactors = [
        { number: "8+", label: "Años de Experiencia", icon: <FiDatabase className="text-blue-400 text-xl" /> }, // Tamaño aumentado
        { number: "20+", label: "Empresas Transformadas", icon: <FiUsers className="text-teal-400 text-xl" /> }, // Tamaño aumentado
        { number: "95%", label: "Mejora en Toma de Decisiones", icon: <FiCheckCircle className="text-purple-400 text-xl" /> }, // Tamaño aumentado
        { number: "24/7", label: "Acceso a Información", icon: <FiBarChart2 className="text-amber-400 text-xl" /> } // Tamaño aumentado
    ];
        ...
        <section className="relative py-20 md:py-32 bg-gradient-to-br from-gray-950 via-slate-900 to-blue-950/20 text-white overflow-hidden pt-28">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    >
                        <FiTarget className="text-blue-400 mr-2" />
                        <span className="text-xs font-semibold text-blue-300 tracking-widest">DECISIONES INTELIGENTES</span>
                    </motion.div>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
                        ...
                        <span className="block mt-2 text-white/90">
                            Transforma Datos en Estrategia
                        </span>
                    </h2>
                    <p className="text-lg text-blue-100/80 max-w-3xl mx-auto leading-relaxed font-light">
                        ...
                        Nuestra contabilidad gerencial convierte tus datos financieros
                        en insights poderosos que impulsan el crecimiento y la eficiencia
                        de tu empresa.
                    </p>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-28">
                    ...
                    >
                        <h3 className="text-2xl md:text-3xl font-bold mb-6 text-white">
                            Herramientas para Directivos Exitosos
                        </h3>
                        <p className="text-blue-100/90 mb-8 leading-relaxed">
                            Nuestros servicios de contabilidad gerencial están diseñados para proporcionar
                            a directivos y gerentes las herramientas necesarias para entender, controlar
                            y mejorar continuamente el desempeño financiero de su organización.
                        </p>
                            ...
                            <div className="bg-gradient-to-br from-gray-900/70 to-blue-900/10 rounded-3xl p-8">
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <div className="flex items-center bg-gradient-to-r from-green-500/15 to-teal-500/15 text-green-300 px-3 py-1.5 rounded-full border border-green-500/20">
                                        ...
                                        <span className="text-xs font-medium">INSIGHTS ACCIONABLES</span>
                                    </div>
                                </div>
                ...
                {/* KPIs section mejorada */}
                <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    whileHover={{ y: -5 }} // Efecto lift en el contenedor del KPI
                ...
                >
                    {/* Elementos flotantes decorativos en el KPI */}
                    ...
                    <div className="text-center max-w-4xl mx-auto relative z-10">
                        ...
                        <h4 className="text-2xl font-bold text-white mb-4">Resultados Medibles</h4>
                        <p className="text-lg text-blue-100/90 mb-8 leading-relaxed">
                            Nuestra contabilidad gerencial no solo informa, sino que también impulsa resultados tangibles.
                            Empresas que implementan nuestros servicios reportan mejoras significativas en sus indicadores clave.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { stat: "40%", label: "Incremento en Rentabilidad", desc: "Promedio anual reportado" },
                                { stat: "60%", label: "Reducción Tiempo Análisis", desc: "Automatización de reportes" },
                                { stat: "85%", label: "Mejora en Precisión", desc: "De proyecciones financieras" }
                            ].map((item, index) => (
                                <motion.div
                                    key={index}
...
export default ContabilidadGerencial;