...
import { FiBarChart2, FiTrendingUp, FiTarget, FiUsers, FiCheckCircle, FiArrowRight, FiPieChart, FiActivity } from 'react-icons/fi';
...
const ContabilidadGerencial = () => {
    const benefits = [
        ...
        },
        {
            ...
            description: "Proyecciones basadas en datos para planificar el futuro.",
            icon: <FiTrendingUp className="text-purple-400" />,
            color: "from-purple-500/10 to-purple-400/10"
        },
        {
            title: "Eficiencia Operativa",
            description: "Identificación de áreas de mejora y optimización de recursos.",
    ...
    const trustFactors = [
        { number: "8+", label: "Años de Experiencia", icon: <FiBarChart2 className="text-blue-400" /> },
        { number: "20+", label: "Empresas Transformadas", icon: <FiUsers className="text-teal-400" /> },
        { number: "85%", label: "Mejora en Toma de Decisiones", icon: <FiTrendingUp className="text-purple-400" /> },
        { number: "24/7", label: "Acceso a Información", icon: <FiActivity className="text-amber-400" /> }
    ];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <p className="text-lg text-blue-100/80 max-w-3xl mx-auto leading-relaxed font-light">
                        Convierte la información financiera en ventajas competitivas. Nuestra contabilidad
                        gerencial proporciona insights claros y accionables que impulsan el crecimiento
                        estratégico de tu empresa con decisiones basadas en datos reales.
                    </p>
                </motion.div>
                        ...
                        <div className="relative bg-gradient-to-br from-white/5 via-white/2 to-blue-900/5 backdrop-blur-2xl rounded-3xl p-0.5 border border-white/15 shadow-2xl">
                            <div className="bg-gradient-to-br from-gray-900/70 to-blue-900/10 rounded-3xl p-8">
                                <div className="flex items-center justify-between mb-8">
                                    <h4 className="text-xl font-semibold text-white">Ventajas Gerenciales</h4>
                                    <div className="flex items-center bg-gradient-to-r from-green-500/15 to-teal-500/15 text-green-300 px-3 py-1.5 rounded-full border border-green-500/20">
                                        ...
                                        <span className="text-xs font-medium">INSIGHTS 360°</span>
                                    </div>
                                </div>
                ...
                >
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <h4 className="text-2xl font-bold text-white mb-4">Impacto Comprobado en Negocios</h4>
                        <p className="text-lg text-blue-100/90 mb-8 leading-relaxed">
                            Nuestras soluciones de contabilidad gerencial han ayudado a directivos a
                            mejorar su toma de decisiones en un 75%, reducir costos operativos en un
                            promedio del 28%, y aumentar la rentabilidad en un 32% en el primer año.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { stat: "75%", label: "Mejora en Toma de Decisiones", desc: "Basada en datos reales" },
                                { stat: "28%", label: "Reducción de Costos", desc: "Operativos promedio" },
                                { stat: "32%", label: "Incremento Rentabilidad", desc: "Primer año de implementación" }
                            ].map((item, index) => (
