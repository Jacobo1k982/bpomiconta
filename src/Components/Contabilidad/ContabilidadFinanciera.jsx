// src/components/ContabilidadFinanciera.tsx
...
const ContabilidadFinanciera = () => {
    const benefits = [
        {
            ...
            icon: <FiBarChart2 className="text-blue-400 text-xl" />, // Tamaño aumentado
            color: "from-blue-500/10 to-blue-400/10"
        },
        {
            title: "Cumplimiento Garantizado",
            description: "Nos aseguramos de que tu empresa cumpla con todas las normativas fiscales vigentes.",
            icon: <FiShield className="text-teal-400 text-xl" />, // Tamaño aumentado
            color: "from-teal-500/10 to-teal-400/10"
        },
        {
            title: "Toma de Decisiones",
            description: "Datos financieros confiables para guiar el crecimiento estratégico de tu negocio.",
        ...
        },
        {
            ...
            icon: <FiDollarSign className="text-amber-400 text-xl" />, // Tamaño aumentado
    ...
    const trustFactors = [
        { number: "8+", label: "Años de Experiencia", icon: <FiBook className="text-blue-400 text-xl" /> }, // Tamaño aumentado
        { number: "20+", label: "Empresas Atendidas", icon: <FiUsers className="text-teal-400 text-xl" /> }, // Tamaño aumentado
        { number: "98%", label: "Clientes Satisfechos", icon: <FiCheckCircle className="text-purple-400 text-xl" /> }, // Tamaño aumentado
        { number: "100%", label: "Cumplimiento Legal", icon: <FiShield className="text-amber-400 text-xl" /> } // Tamaño aumentado
    ];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-xs font-semibold text-blue-300 tracking-widest">CONTABILIDAD EXPERTA</span>
                    </motion.div>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
                        ...
                        <span className="block mt-2 text-white/90">
                            La Base de tu Crecimiento Sostenible
                        </span>
                    </h2>
                    <p className="text-lg text-blue-100/80 max-w-3xl mx-auto leading-relaxed font-light">
                        Transforma tu información financiera en una ventaja competitiva.
                        Nuestra contabilidad financiera precisa y oportuna te proporciona
                        la claridad necesaria para tomar decisiones inteligentes y asegurar
                            ...
                            <div className="bg-gradient-to-br from-gray-900/70 to-blue-900/10 rounded-3xl p-8">
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <div className="flex items-center bg-gradient-to-r from-green-500/15 to-teal-500/15 text-green-300 px-3 py-1.5 rounded-full border border-green-500/20">
                                        ...
                                        <span className="text-xs font-medium">VISIBILIDAD FINANCIERA</span>
                                    </div>
                                </div>
                ...
                {/* Testimonial section mejorada */}
                <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    whileHover={{ y: -5 }} // Efecto lift en el contenedor del testimonio
                    className="relative bg-gradient-to-r from-white/5 to-white/2 backdrop-blur-lg rounded-3xl p-8 border border-white/10 shadow-xl overflow-hidden" // Sombra mejorada
                >
                    {/* Elementos flotantes decorativos en el testimonio */}
                    ...
                    <div className="text-center max-w-3xl mx-auto relative z-10">
                        ...
                        <blockquote className="text-xl md:text-2xl italic text-blue-100 mb-6">
                            "La contabilidad precisa de BPOMICONTA nos ha permitido tomar decisiones estratégicas con total confianza.
                            Ahora tenemos una visión clara de nuestra rentabilidad y podemos planificar el crecimiento de forma sostenible."
                        </blockquote>
                        <div className="flex items-center justify-center">
                            <div className="bg-gradient-to-br from-white/10 to-white/5 p-1 rounded-full mr-4">
                                <div className="bg-gray-200 border-2 border-dashed rounded-xl w-16 h-16" />
                            </div>
                            <div className="text-left">
                                <p className="font-bold text-white">María Rodríguez</p>
                                <p className="text-blue-200/80">Directora Financiera, TechSolutions S.A.</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
